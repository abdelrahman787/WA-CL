...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/session-1/qr
```
...
curl -X POST \
  -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/session-1/restart
```
...
curl -X POST \
  -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/session-1/logout
```
...
```bash
curl -H "X-API-Key: $API_KEY" \
  "http://localhost:3000/api/sessions/default/messages?phone=628123456789@c.us&limit=50"
```
...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/messages/MSG_ABC123
```
...
```bash
curl -X POST http://localhost:3000/api/sessions/default/messages/MSG_ABC123/react \
  -H "X-API-Key: $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"emoji": "👍"}'
```
...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/contacts
```
...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/contacts/628123456789
```
...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/contacts/628123456789/exists
```
...
curl -X POST \
  -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/contacts/628123456789/block
```
...
curl -X POST \
  -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/contacts/628123456789/unblock
```
...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/groups
```
...
```bash
curl -X POST http://localhost:3000/api/sessions/default/groups \
  -H "X-API-Key: $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "New Group",
...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/groups/120363123456789@g.us
```
...
```bash
curl -X PATCH http://localhost:3000/api/sessions/default/groups/120363123456789@g.us \
  -H "X-API-Key: $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X POST http://localhost:3000/api/sessions/default/groups/120363123456789@g.us/participants \
  -H "X-API-Key: $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE http://localhost:3000/api/sessions/default/groups/120363123456789@g.us/participants \
  -H "X-API-Key: $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X POST http://localhost:3000/api/sessions/default/groups/120363123456789@g.us/admins \
  -H "X-API-Key: $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE http://localhost:3000/api/sessions/default/groups/120363123456789@g.us/admins \
  -H "X-API-Key: $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "participants": ["628123456789@c.us"]
...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/groups/120363123456789@g.us/invite-code
```
...
curl -X POST \
  -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/default/groups/120363123456789@g.us/invite-code/revoke
```
...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/sess_abc123/webhooks
```
...
```bash
curl -X POST http://localhost:3000/api/sessions/sess_abc123/webhooks \
  -H "X-API-Key: $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "url": "https://your-server.com/webhook",
...
```bash
curl -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/sess_abc123/webhooks/wh_456
```
...
```bash
curl -X PATCH http://localhost:3000/api/sessions/sess_abc123/webhooks/wh_456 \
  -H "X-API-Key: $API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -H "X-API-Key: $API_KEY" \
  "http://localhost:3000/api/sessions/sess_abc123/webhooks/wh_456/logs?limit=20"
```
...
curl -X POST \
  -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/sessions/sess_abc123/webhooks/wh_456/test
```
...
curl -X DELETE \
  -H "X-API-Key: $API_KEY" \
  http://localhost:3000/api/api-keys/key_456
```

## 14.9 Postman Collection
...
## 14.10 cURL Examples Collection
...
[← 13 - Troubleshooting FAQ](./13-troubleshooting-faq.md) · [📚 Documentation Index](./README.md) · [15 - SDK Design →](./15-sdk-design.md)
