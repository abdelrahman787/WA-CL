...
|----------------|----------|-----------|--------|
| FR-SM-001 | UC-003 | TC-SM-001 | Planned |
| FR-SM-002 | UC-003 | TC-SM-002 | Planned |
| FR-MSG-001 | UC-001 | TC-MSG-001 | Planned |
| FR-WH-001 | UC-002 | TC-WH-001 | Planned |
...
[← 01 - Project Overview](./01-project-overview.md) · [📚 Documentation Index](./README.md) · [03 - System Architecture →](./03-system-architecture.md)
