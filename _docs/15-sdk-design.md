...
## 15.2 TypeScript/JavaScript SDK
...
client = OpenWASync(base_url="http://localhost:3000", api_key="your-key")
...
[← 14 - API Collection](./14-api-collection.md) · [📚 Documentation Index](./README.md) · [16 - Dashboard Design →](./16-dashboard-design.md)
