...
# Send image
curl -X POST http://localhost:3000/api/sessions/sess_abc123/messages/send-image \
  -H "Content-Type: application/json" \
  -H "X-API-Key: your-api-key" \
...
# Usage
client = OpenWA('http://localhost:3000/api', 'your-api-key')
...
[← 03 - System Architecture](./03-system-architecture.md) · [📚 Documentation Index](./README.md) · [05 - Database Design →](./05-database-design.md)
